...
class GroupChatAdapter(ViewModel: MainViewModel) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        (holder as MessageHolder).drawMessage(
            mListMessagesCache[holder.adapterPosition],
            mViewModel
        )
    ...
    override fun onViewAttachedToWindow(holder: RecyclerView.ViewHolder) {
        (holder as MessageHolder).onAttach(
            mListMessagesCache[holder.adapterPosition],
            mViewModel
        )
